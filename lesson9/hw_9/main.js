...
//
// //let simpBlock = document.querySelectorAll('.simpsons')[0];-- синтаксис
//
// let memberBlock= document.getElementsByClassName('member')[0];
// for (const simpElement of simpsons) {
//   let divElement= document.createElement('div')
//     divElement.classList.add('member')
//     memberBlock.append(divElement)
//     let h1= document.createElement('h1')
//     h1.innerText=simpElement.name+' '+simpElement.surname+' '+simpElement.age
//     let p=document.createElement('p')
//     p.innerText=simpElement.info
//     let img=document.createElement('img')
//     img.src=simpElement.photo
//     memberBlock.append(h1,p,img)
// }

//---------2------------розкоментувати div в html---
// Цикл в циклі
// - Є масив
// let coursesArray = [
//     {
...
//     divBlock.classList.add('num1')
//     divBlock.appendChild(block)
//     let block1=document.createElement('div')
//     block1.innerText=` title: ${courseElement.title}`
//     let block2=document.createElement('div')
//     block2.innerText='monthDuration: '+courseElement.monthDuration
//     let block3=document.createElement('div')
//     block3.innerText='hourDuration: '+courseElement.hourDuration
//     let block4=document.createElement('p')
//     block4.innerText=' modules: '
//     divBlock.append(block1,block2,block3,block4)
//     let ul =document.createElement('ul')
//     divBlock.append(ul)
//     for (const block4Element of courseElement.modules) {
//         let li=document.createElement('li')
//         li.innerText=block4Element
//         ul.appendChild(li)
//     }}

//-------------3--------розкоментувати div в html---------
// - створити блок,
...
// document.getElementsByName('block')
// for (const arrEl of coursesAndDurationArray) {
//     let tit=document.createElement('h1')
//     tit.innerText='Title: '+arrEl.title
//     let month= document.createElement('div')
//   month.innerText='MonthDuration: '+arrEl.monthDuration
//     block.append(tit,month)
// }
...
// elem1.innerText = 'Line: '
// let elem2 = document.createElement('input')
// elem2.innerText = 'Number:  '
// let elem3 = document.createElement('input')
// elem3.innerText = 'Text: '
// let button = document.createElement('button')
// button.innerText = 'Click'
// document.body.append(elem1, elem2, elem3, button)
//
// button.addEventListener('click', () => {
//     let one = elem1.value;
//     let two = elem2.value;
//     let three = elem3.value
//     const generateTable = (line, number, text) => {
//         let table = document.createElement('table')
//         table.style.background = 'plum'
